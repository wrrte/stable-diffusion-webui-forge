...
parser.add_argument("--auto-generate", nargs='?', const="/Users/choemj/Painting/prompts_hr_disable.txt", type=str, help="Auto generate images from prompts file without launching the UI.", default=None)
parser.add_argument("--auto-generate-once", nargs='?', const="/Users/choemj/Painting/prompts.txt", type=str, help="Auto generate exactly one image from prompts file without launching the UI and then exit.", default=None)
