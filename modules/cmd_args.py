...
parser.add_argument("--auto-generate", nargs='?', const="/Users/choemj/Desktop/prompts_hr_disable.txt", type=str, help="Auto generate images from prompts file without launching the UI.", default=None)
